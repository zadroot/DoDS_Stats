...
LoadConVars()
{
	...
	AddConVar(Purge,             ValueType_Int,  CreateConVar("dodstats_purge",            "0",    "Number of days to delete inactive players from the database",                         FCVAR_PLUGIN, true, 0.0));
	...
	AddConVar(Points_TK_Penalty, ValueType_Int,  CreateConVar("dodstats_points_teamkill",  "8",    "Amount of points to take on team kill (TNT kills will be ignored anyway)",            FCVAR_PLUGIN, true, 0.0, true, 25.0));
	...
	AddConVar(Points_Capture,    ValueType_Int,  CreateConVar("dodstats_points_capture",   "2",    "Amount of points to give for capturing area",                                         FCVAR_PLUGIN, true, 0.0, true, 25.0));
	AddConVar(Points_Block,      ValueType_Int,  CreateConVar("dodstats_points_block",     "2",    "Amount of points to give for blocking capture",                                       FCVAR_PLUGIN, true, 0.0, true, 25.0));
	...
	AddConVar(Points_Plant,      ValueType_Int,  CreateConVar("dodstats_points_plant",     "2",    "Amount of points to give for planting a TNT",                                         FCVAR_PLUGIN, true, 0.0, true, 25.0));
	AddConVar(Points_Defuse,     ValueType_Int,  CreateConVar("dodstats_points_defuse",    "2",    "Amount of points to give for defusing a TNT",                                         FCVAR_PLUGIN, true, 0.0, true, 25.0));
	...
	AddConVar(Points_RoundWin,   ValueType_Int,  CreateConVar("dodstats_points_victory",   "1",    "Amount of points to give to all members of team which is won the round",              FCVAR_PLUGIN, true, 0.0, true, 25.0));

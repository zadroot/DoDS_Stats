...
LoadConVars()
{
	...
	AddConVar(MeleeMultipler,    ValueType_Int,  CreateConVar("dodstats_multipler_melee",  "2",    "Sets the multipler for killing by melee weapons (knife, spade and punch)",            FCVAR_PLUGIN, true, 1.0, true, 25.0));

	AddConVar(Points_TK_Penalty, ValueType_Int,  CreateConVar("dodstats_points_teamkill",  "8",    "Amount of points to take on team kill (TNT kills is ignored)",                        FCVAR_PLUGIN, true, 0.0, true, 25.0));
